-- Drop and recreate strava_activities table with correct field sizes
-- This script fixes all numeric field overflow issues
...
-- Create strava_activities table with proper field sizes
CREATE TABLE public.strava_activities (
  ...
  start_latlng DECIMAL(12,8)[], -- increased precision for GPS coordinates
  end_latlng DECIMAL(12,8)[], -- increased precision for GPS coordinates
